; ModuleID = 'examples/exp2/O1/exp2.c'
source_filename = "examples/exp2/O1/exp2.c"
...
20:                                               ; preds = %34
  %21 = fadd double %36, 1.000000e+00
  br label %39

22:                                               ; preds = %18, %34
  %23 = phi i64 [ %37, %34 ], [ %10, %18 ]
  %24 = phi double [ %36, %34 ], [ 0.000000e+00, %18 ]
  %25 = add i64 %23, 1
  %26 = tail call i64 @llvm.umax.i64(i64 %25, i64 2)
  br label %27

27:                                               ; preds = %27, %22
  %28 = phi i64 [ %32, %27 ], [ 1, %22 ]
  %29 = phi double [ %31, %27 ], [ 1.000000e+00, %22 ]
...
34:                                               ; preds = %27
  ...
  %37 = add i64 %23, -1
  %38 = icmp eq i64 %37, 0
  br i1 %38, label %20, label %22, !llvm.loop !8

39:                                               ; preds = %18, %20
  %40 = phi double [ 1.000000e+00, %18 ], [ %21, %20 ]
  br label %43

41:                                               ; preds = %43
  %42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %46)
  br label %49

43:                                               ; preds = %39, %43
  %44 = phi i64 [ 0, %39 ], [ %47, %43 ]
  %45 = phi double [ 0.000000e+00, %39 ], [ %46, %43 ]
  %46 = fadd double %40, %45
  %47 = add nuw nsw i64 %44, 1
  %48 = icmp eq i64 %47, 10000
  br i1 %48, label %41, label %43, !llvm.loop !15

49:                                               ; preds = %41, %16
  %50 = phi i32 [ 1, %16 ], [ 0, %41 ]
  ret i32 %50
}
