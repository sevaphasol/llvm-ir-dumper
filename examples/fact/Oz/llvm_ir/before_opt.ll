...
8:                                                ; preds = %1
  ...
  %10 = sub i64 %9, 1
  %11 = call i64 @fact(i64 noundef %10) #6
...
21:                                               ; preds = %12
  ...
  %24 = call i64 @fact(i64 noundef %23) #6
  %25 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %22, i64 noundef %24) #6
  br label %28
...
; Function Attrs: minsize nounwind optsize willreturn memory(read)
declare i32 @atoi(ptr noundef) #3

; Function Attrs: minsize nounwind optsize willreturn memory(none)
...
attributes #3 = { minsize nounwind optsize willreturn memory(read) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #4 = { minsize nounwind optsize willreturn memory(none) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #5 = { nounwind }
attributes #6 = { minsize optsize }
attributes #7 = { minsize nounwind optsize willreturn memory(read) }
attributes #8 = { minsize nounwind optsize willreturn memory(none) }
