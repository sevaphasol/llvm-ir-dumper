...
DumpPass::run( llvm::Module& module, llvm::ModuleAnalysisManager& /*unused*/ )
{
...
void
DumpPass::dumpModule( llvm::Module&         module,
                      llvm::raw_fd_ostream& ll_dump,
                      llvm::raw_fd_ostream& json_dump )
{
    module.print( ll_dump, nullptr );

    ir_graph::IrGraphBuilder builder;
    auto                     build = builder.build( module );
